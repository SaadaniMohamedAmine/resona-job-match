...
export function SkillTag({ label, variant }: { label: string; variant: "match" | "gap" }) {
  ...
  return (
    <span className="inline-flex items-center gap-1.5 rounded-(--radius-control) border border-track bg-track/40 px-3 py-1.5 text-sm whitespace-nowrap text-base-light">
